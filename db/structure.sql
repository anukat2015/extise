...
CREATE TABLE extisimo_repositories (
    ...
    git_eclipse_org_project_parent character varying NOT NULL
);
...
--
-- Name: index_extisimo_conceptualities_on_subject_type_and_subject_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_extisimo_conceptualities_on_subject_type_and_subject_id ON extisimo_conceptualities USING btree (subject_type, subject_id);
...
--
-- Name: index_extisimo_expertises_on_subject_type_and_subject_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_extisimo_expertises_on_subject_type_and_subject_id ON extisimo_expertises USING btree (subject_type, subject_id);
...
--
-- Name: index_extisimo_repositories_on_git_eclipse_org_project_parent; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_extisimo_repositories_on_git_eclipse_org_project_parent ON extisimo_repositories USING btree (git_eclipse_org_project_parent);
...
--
-- Name: index_extisimo_tasks_on_assignee_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_extisimo_tasks_on_assignee_id ON extisimo_tasks USING btree (assignee_id);
...
--
-- Name: index_extisimo_tasks_on_project_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_extisimo_tasks_on_project_id ON extisimo_tasks USING btree (project_id);


--
-- Name: index_extisimo_tasks_on_reporter_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_extisimo_tasks_on_reporter_id ON extisimo_tasks USING btree (reporter_id);
